# Reza Hajianpour's Proprietary License (RHPL), Revision 1

## SOFTWARE LICENSE AGREEMENT
This Software License Agreement ("Agreement") is made and entered into as of 2024-04-17 ("Effective Date") by and between Mohammad Reza Hajianpour, private-person, having its principal place of business at Zanjan, Iran ("Licensor"), and you (the "User" or "Licensee").
...
The term "Software" refers to the 7mm, including any updates, modifications, or associated documentation provided by Licensor.
...
### Licensor: Mohammad Reza Hajianpour <hajianpour.mr@gmail.com>

### Licensee: You (the "User")
